                                                ...
                                                <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                    ...
                                                    <tbody>                 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if($st=='0'):?>
                                                                    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']);?>" title="Disapprove this comment"><button class="btn btn-primary">DISAPPROVE</button></a> 
                                                                <?php else :?>
                                                                ...
                                                                &nbsp;<a href="unapprove-comment.php?rid=<?php echo htmlentities($row['id']);?>&&action=del" onclick="return confirm('Do you really want to delete ?')"> <button class="btn btn-danger">DELETE</button></a> 
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $cnt++;
