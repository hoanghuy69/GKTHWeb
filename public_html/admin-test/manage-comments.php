                                            ...
                                            <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($st==0):?>
                                                                <a href="manage-comments.php?disid=<?php echo htmlentities($row['id']);?>" title="Disapprove this comment"><button class="btn btn-primary">DISAPPROVE</button></a> 
                                                            <?php else :?>
                                                                <a href="manage-comments.php?appid=<?php echo htmlentities($row['id']);?>" title="Approve this comment"><button class="btn btn-primary">APPROVE</button></a> 
                                                            <?php endif;?>
                                                                &nbsp;<a href="manage-comments.php?rid=<?php echo htmlentities($row['id']);?>&&action=del" onclick="return confirm('Do you really want to delete ?')"> <button class="btn btn-danger">DELETE</button></a> 
                                                        </td>
                                                    </tr>
                                                <?php
                                                $cnt++;
