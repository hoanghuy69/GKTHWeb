                                                ...
                                                <tbody>
                                                    ...
                                                    else 
                                                    {
                                                        ...
                                                        ?>
                                                            ...
                                                            <td>
                                                            <a href="trash-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=restore" onclick="return confirm('Do you really want to restore ?')"><button class="btn btn-primary" title="Restore this Post">RESTORE</button></a>
                                                                &nbsp;
                                                                <a href="trash-posts.php?presid=<?php echo htmlentities($row['postid']);?>&&action=perdel" onclick="return confirm('Do you really want to delete ?')"><button class="btn btn-danger" title="Delete this Post">DELETE</button></a> 
                                                            </td>
                                                            </tr>
                                                    <?php } }?>                                                
                                                </tbody>
