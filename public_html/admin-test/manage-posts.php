                                                ...
                                                <tbody>
                                                    ...
                                                    else 
                                                    {
                                                        ...
                                                        <td>
                                                            ...
                                                            &nbsp;<a href="manage-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=del" onclick="return confirm('Do you reaaly want to delete ?')"> <button class="btn btn-danger">DELETE</button></a> 
                                                        </td>
                                                        </tr>
                                                        <?php } 
                                                    }?>
