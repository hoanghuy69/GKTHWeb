                                                ...
                                                <tbody>
                                                    ...
                                                    else 
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="edit-subcategory.php?scid=<?php echo htmlentities($row['subcatid']);?>"><button class="btn btn-primary">EDIT</button></a> 
                                                                &nbsp;<a href="manage-subcategories.php?scid=<?php echo htmlentities($row['subcatid']);?>&&action=del" onclick="return confirm('Do you really want to delete ?')"> <button class="btn btn-danger">DELETE</button></a> 
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $cnt++;
                                            ...
                                            <tbody>
                                                ...
                                                else 
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($row['subcatpostingdate']);?></td>
                                                        <td><?php echo htmlentities($row['subcatupdationdate']);?></td>
                                                        <td><a href="manage-subcategories.php?resid=<?php echo htmlentities($row['subcatid']);?>"><button class="btn btn-primary" title="Restore this SubCategory">RESTORE</button></a>
                                                            &nbsp;<a href="manage-subcategories.php?scid=<?php echo htmlentities($row['subcatid']);?>&&action=perdel" onclick="return confirm('Do you really want to delete ?')"> <button class="btn btn-danger">DELETE</button></a> 
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $cnt++;
