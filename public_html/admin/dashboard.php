...
{ 
    ...
    <html lang="en">
        <head>
            ...
            <!-- App title -->
            <title>Báo đây! Admin Page</title>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one">
                                            ...
                                            <div class="wigdet-one-content">
                                                ...
                                                <?php 
                                                    $numCate = $db->fetchsql('SELECT * FROM tbl_danhmuc WHERE trangThai=1');
                                                    $countcat=count($numCate);
                                                ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one">
                                            ...
                                            <div class="wigdet-one-content">
                                                ...
                                                <?php 
                                                    $numSubCate = $db->fetchsql('SELECT * FROM tbl_danhmuccon WHERE trangThai=1');
                                                    $countsubcat=count($numSubCate);
                                                ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one">
                                            ...
                                            <div class="wigdet-one-content">
                                                ...
                                                <?php 
                                                    $numPost=$db->fetchsql("SELECT * FROM tbl_baiviet WHERE trangThai=1");
                                                    $countposts=count($numPost);
                                                ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one">
                                            ...
                                            <div class="wigdet-one-content">
                                                ...
                                                <?php 
                                                    $numDelPost=$db->fetchsql("SELECT * FROM tbl_baiviet WHERE trangThai=0");
                                                    $countDelPosts=count($numDelPost);
                                                ?>
                                                <h2><?php echo htmlentities($countDelPosts);?> <small></small></h2>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6">
                                            <div class="card-box widget-box-one">
                                                ...
                                                <div class="wigdet-one-content">
                                                    ...
                                                    <?php 
                                                        $numAdmin = $db->fetchsql("SELECT * FROM tbl_admin");
                                                        $countAdmin=count($numAdmin);
                                                    ?>
                                                    <h2><?php echo htmlentities($countAdmin);?> <small></small></h2>
