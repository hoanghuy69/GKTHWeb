...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"SELECT AdminPassword FROM tbladmin WHERE AdminUserName='$adminid' OR AdminEmailId='$adminid'");
    ...
    if(COUNT($num)>0)
    {
        ...
        {
            $con=mysqli_query($con,"UPDATE tbladmin SET AdminPassword='$newhashedpass' WHERE AdminUserName='$adminid' OR AdminEmailId='$adminid' ");
